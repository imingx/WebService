 ...
 * 
 */
@WebServiceClient(name = "StudentService", targetNamespace = "http://server", wsdlLocation = "http://localhost:8080/services/Student?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICE_QNAME = new QName("http://server", "StudentService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/services/Student?wsdl");
     ...
     *     returns Student
     */
    @WebEndpoint(name = "Student")
    public Student getStudent() {
        return super.getPort(new QName("http://server", "Student"), Student.class);
    }
     ...
     */
    @WebEndpoint(name = "Student")
    public Student getStudent(WebServiceFeature... features) {
        return super.getPort(new QName("http://server", "Student"), Student.class, features);
    }
